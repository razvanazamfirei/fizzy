...
#define TTY_COLOR_HIGHLIGHT (getenv("TTY_COLOR_HIGHLIGHT") != NULL) ? atoi(getenv("TTY_COLOR_HIGHLIGHT")) : TTY_COLOR_YELLOW
// The above line defines TTY_COLOR_HIGHLIGHT as the value of the TTY_COLOR_HIGHLIGHT
// environment variable, or "TTY_COLOR_YELLOW" if it is not set.
